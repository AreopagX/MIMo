...
Sensory inputs consist of touch, proprioception and optionally pain sensations.
Proprioception uses the default settings, but touch excludes several body parts
and uses a lowered resolution to improve runtime.
...
step. Furthermore, large impact forces will be punished with a pain penalty term.
...
from mimoEnv.envs.mimo_env import DEFAULT_PROPRIOCEPTION_PARAMS, SCENE_DIRECTORY
from mimoActuation.actuation import SpringDamperModel
from mimoTouch.pain_touch import PainTouch
...
class MIMoSelfBodyPainEnv(MIMoSelfBodyEnv):
    ...
    def get_pain_obs(self):
        return self.pain.get_touch_obs()

    def _set_observation_space(self):
        """
        Optionally extends the observation space by pain observations.
        """
    ...
    def _get_obs(self):
        """ Adds the pain observations to the observation dictionary.
    ...
    def compute_reward(self, achieved_goal, desired_goal, info):
        ...
        - The maximum value of pain sensations will be subtracted from the reward as a penalty for harmful movements.
        ...
        # pain penalty is the maximal pain sensation
